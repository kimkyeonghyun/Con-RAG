...
class ArgParser():
    def __init__(self):
        ...
        #Task arguments
        task_list = ['preprocessing', 'classification', 'generation']
        self.parser.add_argument('--task', type = str, choices = task_list, default = 'classification',
                                 help = 'Task to do; Must be given.')
        job_list = ['preprocessing', 'retriever', 'training', 'resume_training', 'testing', 'generation', 'generation_test']
        ...
        self.parser.add_argument('--task_dataset', type = str, choices = dataset_list, default = 'triviaqa',
        ...
        self.parser.add_argument('--proj_name', type = str, default = 'Question_Classification',
                                 help = 'Name of the project.')
        model_type_list = ['t5-small', 't5-base', 't5-large',]
        self.parser.add_argument('--model_type', type = str, choices = model_type_list, default = 'flan-t5',
        ...
        self.parser.add_argument('--use_wandb', type=parse_bool, default=False,
                                 help='Using wandb; Default is False')
